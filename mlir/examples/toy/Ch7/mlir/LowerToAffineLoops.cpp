  ...
  matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    auto forK = rewriter.create<affine::AffineForOp>(
        ...
        [&](OpBuilder &nestedBuilder, Location loc, Value ivK,
          ...
          nestedBuilder.create<affine::AffineYieldOp>(loc, sum);
        });

    rewriter.create<affine::AffineStoreOp>(loc, forK.getResult(0), alloc,
                                          ValueRange{ivI, ivJ});
...
void ToyToAffineLoweringPass::runOnOperation() {
  ...
  patterns.add<AddOpLowering, ConstantOpLowering, FuncOpLowering, MulOpLowering, 
               MatMulOpLowering, NegOpLowering,
